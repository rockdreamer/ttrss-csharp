...
{
    public class UnsubscribeFeedRequest : TTRssApiRequest
    {

        [JsonProperty("feed_id")]
        public int feed_id { get; set; }

        public UnsubscribeFeedRequest(int req)
        {
            this.sequence = req;
            this.operation = "unsubscribeFeed";
        }

        public UnsubscribeFeedResponse response { get; set; }
    }

    public class UnsubscribeFeedResponseContent
    {
        [JsonProperty("error")]
    ...
    public class UnsubscribeFeedResponse
    {
        ...
        public UnsubscribeFeedResponseContent Content { get; set; }
    }
