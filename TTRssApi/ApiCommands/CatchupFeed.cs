...
{
    public class CatchupFeedRequest : TTRssApiRequest
    {
        ...
        public CatchupFeedRequest(int req)
        {
            this.sequence = req;
            this.operation = "catchupFeed";
        }

        public CatchupFeedResponse response { get; set; }
    }

    public class CatchupFeedResponseContent
    {
        [JsonProperty("error")]
    ...
    public class CatchupFeedResponse
    {
        ...
        public CatchupFeedResponseContent Content { get; set; }
    }
