...
{
    public class GetApiLevelRequest : TTRssApiRequest
    {

        public GetApiLevelRequest(int req)
        {
            this.sequence = req;
            this.operation = "getApiLevel";
        }

        public GetApiLevelResponse response { get; set; }
    }

    public class GetApiLevelResponseContent
    {
        [JsonProperty("error")]
    ...
    public class GetApiLevelResponse
    {
        ...
        public GetApiLevelResponseContent Content { get; set; }
    }
