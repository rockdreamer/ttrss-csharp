...
{
    public class GetUnreadRequest : TTRssApiRequest
    {

        public GetUnreadRequest(int req)
        {
            this.sequence = req;
            this.operation = "getUnread";
        }

        public GetUnreadResponse response { get; set; }
    }

    public class GetUnreadResponseContent
    {
        [JsonProperty("error")]
    ...
    public class GetUnreadResponse
    {
        ...
        public GetUnreadResponseContent Content { get; set; }
    }
